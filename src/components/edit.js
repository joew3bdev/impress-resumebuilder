...
class Edit extends React.Component {
  ...
  componentDidMount() {
    this.setState({
      name: this.props.commonReducer.resume.name,
      email: this.props.commonReducer.resume.email,
      address: this.props.commonReducer.resume.address,
      phone: this.props.commonReducer.resume.phone,
      companyIndex: this.props.commonReducer.resume.company ? this.props.commonReducer.resume.company : [1],
      company: this.props.commonReducer.resume.company ? this.props.commonReducer.resume.company : [],
      educationIndex: this.props.commonReducer.resume.education ? this.props.commonReducer.resume.education : [1],
      education: this.props.commonReducer.resume.education ? this.props.commonReducer.resume.education : [],
      skills: this.props.commonReducer.resume.skills,
    });
  }
  ...
  submit = async () => {
    ...
    if (
      Object.values(resume).includes(false) ||
      !resume.company.length ||
      !resume.education.length ||
      !resume.skills.length
    ) {
      Toast("error", "Fill all the feilds");
    } else {
      const data = await this.props.actions.editResume(resume);
      if(data){
                ...
                return (
                  <div key={index} className={"p-3 company" + index}>
                    ...
                    <Input
                      ...
                      value={
                        this.state.company[index] &&
                        this.state.company[index]["designation"]
                          ? this.state.company[index]["designation"]
                          : ""
                      }
                      onchange={(value) => {
                  ...
                  <div key={index} className={"p-3 education" + index}>
                    <Input
                      ...
                      value={
                        ...
                        this.state.education[index]["institute"]
                          ? this.state.education[index]["institute"]
                          : ""
                      }
                      onchange={(value) => {
                    ...
                    <Input
                      ...
                      value={
                        this.state.education[index] &&
                        this.state.education[index]["year"]
                          ? this.state.education[index]["year"]
                          : ""
                      }
                      onchange={(value) => {
